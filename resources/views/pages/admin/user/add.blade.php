  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-12 text-gray-500 overflow-x-auto">
                  <header>
                  ...
                  <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data" class="mt-6 space-y-6">
                      ...
                      <div class="max-w-xl">
                          <div class="form-control">
                              ...
                              <x-text-input id="nik" name="nik" type="text" class="mt-1 block w-full" :value="old('nik')" required autofocus />
                      ...
                      <div class="max-w-xl">
                        <div class="form-control">
                            <x-input-label for="role" :value="__('Peran')" required />
                            <x-select-input id="role" name="role" :options="$roleOptions" :value="old('role')" required />
